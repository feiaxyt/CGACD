...
parser.add_argument('--search_size', type=int, default=255, help='size of cropped search region')
parser.add_argument('--enable_mask', action='store_false', help='whether crop mask')
...
def main(exemplar_size=127, context_amount=0.5, search_size=511, enable_mask=True, num_threads=24):
    ...
    data_dir = '/ssd/feiji/Research/Data/COCO'
    crop_path = '/ssd/feiji/Research/Data/COCO_crop{:d}'.format(search_size)
...
if __name__ == '__main__':
    since = time.time()
    main(args.exemplar_size, args.context_amount, args.search_size, False, args.num_threads)
